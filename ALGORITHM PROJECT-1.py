...
print(f'Total electricty consumption for Industrial {round(consumptionCounterLightning,2)}')
...
print(f'Number of public, private and other single percentage{round((publicSingle/counterPublic*100),2)}%')
...
print(f'This consumers total bill: {round(maxTotalInvoiceDailyAverage,2)}')
...
print(f'The precentage of those who made a loss {round((counterMultiLossConsumers/counterOtherThanMartyrLightning*100),2)}')

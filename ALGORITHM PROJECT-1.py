...
DAILY_AVARAGE_UPPER_LIMIT_PUBLIC_AND_PRIVATE_SECTOR_LOW_TARIFF = 30
DAILY_AVARAGE_UPPER_LIMIT_FOR_RESIDENTIAL_LOW_TARIFF=8
...
while True:
    ...
    allCustomersGDZRevenue += totalConsumptionFee
